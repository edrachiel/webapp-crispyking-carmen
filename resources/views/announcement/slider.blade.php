<x-app-layout>
    ...
    <div class = "py-12">
        ...
        <div class="">
    <h3 class="text-center float-left m-5 text-2xl font-bold text-orange-50">Announcements</h3>
</div>
{{-- <div class="flex items-center justify-center my-8">
    ...
    <div class="p-6 text-gray-900 dark:text-gray-100">
        <a href="{{ url('/sliders/create') }}">
            <button class=" float-right bg-red-500 hover:bg-red-300 text-white font-bold py-1 px-2 border border-red-500 rounded">     
                       Add Announcement
            </button>
        </a>
    </div>
    ...
    <div class="mx-auto mt-8">
                    ...
                    <table class="min-w-full border-collapse block md:table">
                        <thead class="block md:table-header-group">
                            ...
                            <th class="text-center bg-orange-900 p-2 text-white font-bold md:border md:border-stone-500 text-left block md:table-cell">Description</th>
                            ...
                            <th class="bg-orange-900 p-2 text-white font-bold md:border md:border-stone-500 text-center block md:table-cell">Action</th>
                            </tr>
                            </thead>
                            <tbody class="block md:table-row-group">
                        @foreach ($sliders as $slider)
                        <tr class="bg-amber-200 border border-zinc-500 md:border-none text-danger block md:table-row">
                            <td class="p-2 md:border md:border-zinc-700 text-left text-danger block md:table-cell">{{$slider->description}}</td>
                            <td class="p-2 md:border md:border-zinc-700 text-center text-danger block md:table-cell">
                            <a href="{{ url('/sliders/'.$slider->id.'/edit')}}">
                                        <button class="bg-red-500 hover:bg-red-300 text-white font-bold py-1 px-2 border border-red-500 rounded">Update</button>
                                        </a>
                            <a href="{{ url('/sliders/'.$slider->id.'/delete')}}" onclick="return confirm('Are you sure you want to delete this Slider?');">
                                        <button class="bg-red-500 hover:bg-red-300 text-white font-bold py-1 px-2 border border-red-500 rounded">Delete</button>
                                        </a>
                            </td> 
                        </tr>
                        @endforeach
